...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"javascripts/videoLightning.js":[function(require,module,exports) {
...
(function () {
  ...
  (function (document) {
    var VideoLightning, _bitify, _boolify, _cc, _coverEl, _domStr2, _extObj, _fadeCss, _fadeIn, _fadeOut, _frameCss, _fullHex, _getEl, _gravity, _initYTAPI, _isAry, _isElAry, _isObj, _isStr, _postToVM, _prepHex, _randar, _setSrc, _testEl, _topKeyOfObj, _val, _wrapCss, _wrapCssP, _ytReset, dom, videoLightning;
    ...
    videoLightning = function (_this) {
      return function (obj) {
        ...
        pushRawEls = function pushRawEls(e) {
          var el;
    ...
    VideoLightning = function () {
      ...
      VideoLightning.prototype.buildEls = function () {
        ...
        this.target.insertAdjacentHTML('beforeend', _domStr2({
          tag: 'div',
          attrs: {
            id: "wrap_" + this.inst,
            "class": 'video-wrapper',
      ...
      VideoLightning.prototype.resize = function () {
        ...
        if (!window.vlData.throttle) {
          ...
          if (this.opts.throttle) {
            ...
            throttleOff = function throttleOff() {
    ...
    _boolify = function _boolify(p, d) {
      if (p === false || p === 'false' || p === 0 || p === '0') {
        return false;
      } else {
        return !!p || d;
    ...
    _domStr2 = function _domStr(o) {
      ...
      if (o.children) {
        ...
        for (i = 0, len = ref1.length; i < len; i++) {
          c = ref1[i];
          children += _isObj(c) ? _domStr2(c) : c;
        }
      }
    ...
    _extObj = function _extObj(baseObj, extObj) {
      var k, v;
    ...
    _isStr = function _isStr(obj) {
      return typeof obj === 'string';
    };

    _isAry = function _isAry(obj) {
      return obj instanceof Array;
    };

    _isElAry = function _isElAry(obj) {
    ...
    _topKeyOfObj = function _topKeyOfObj(obj) {
      var k, v;
    ...
    _fullHex = function _fullHex(hex) {
      if (hex === 'transparent') {
        return hex;
      } else {
        return "#" + _prepHex(hex);
    ...
    _fadeOut = function _fadeOut(el, t) {
      var applyFade;
    ...
    _initYTAPI = function _initYTAPI() {
    ...
    _ytReset = function _ytReset(p, s) {
      if (s == null) {
        s = 0;
      }
    ...
    _postToVM = function _postToVM(player, id, k, v) {
      var data;
    ...
    _coverEl = function _coverEl(target, src) {
      var cover;
    ...
    _gravity = function _gravity(el, width, height, fluidity) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","javascripts/videoLightning.js"], null)
//# sourceMappingURL=/videoLightning.84e67ae8.js.map